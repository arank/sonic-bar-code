...
def handle_uploaded_file(f):
    ...
    #saves file as caf
    name = '/home/apps/django/django_projects/Project/sonic_bar_code/static/%s' % f
...
def generate_view(request):
    ...
    while(True):
    	key = generate("/home/apps/django/django_projects/Project/sonic_bar_code/static/%s" % filename, target, base)
    ...
    # send back sound associated with input
